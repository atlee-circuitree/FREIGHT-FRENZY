...
@Autonomous(name="Red Ducky Wheel", group="Linear Opmode")
public class Red_Ducky_Wheel extends BaseAutoOpMode {
    ...
    public void strafeLeft(double inches, double speed) {
        ...
        telemetry.addData("LS Distance", LS_distance.getDistance(DistanceUnit.INCH));
        telemetry.update();
