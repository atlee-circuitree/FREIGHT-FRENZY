...
@Autonomous(name="Blue Wheel Side", group="Linear Opmode")
public class Blue_Wheel_Side extends BaseAutoOpMode {
    ...
    public void strafeLeft() {
        while (LS_distance.getDistance(DistanceUnit.INCH) > 27 + 4) {
    ...
    public void strafeRight() {
        while (RS_distance.getDistance(DistanceUnit.INCH) > 7.5 + 4) {
            drive_FL.setPower(-0.6);
            drive_RL.setPower(0.6);
            drive_FR.setPower(0.6);
            drive_RR.setPower(-0.6);
